...
// playwright-core is a devDependency of the desktop app, which lives beside the skills directory.
const { chromium } = createRequire(join(import.meta.dirname, "../../../../desktop/package.json"))("playwright-core");

const [command, ...args] = process.argv.slice(2);
const port = readFileSync("/tmp/rustcharge-desktop-verify/run.cdp", "utf8").trim();
